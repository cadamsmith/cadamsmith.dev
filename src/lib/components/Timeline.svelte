...
<div class="timeline-selector">
    <button class:selected={currentGroup === 'Work'} onclick={() => handleGroupChange('Work')}>Work</button>
    <button class:selected={currentGroup === 'Education'} onclick={() => handleGroupChange('Education')}>Education</button>
</div>
